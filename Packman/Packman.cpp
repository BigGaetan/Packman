...
// Packman.cpp : définit les comportements de classe de l'application.
//
...
BEGIN_MESSAGE_MAP(CPackmanApp, CWinAppEx)
	ON_COMMAND(ID_APP_ABOUT, &CPackmanApp::OnAppAbout)
...
// Construction de CPackmanApp

CPackmanApp::CPackmanApp() noexcept
{
	...
	SetAppID(_T("Packman.AppID.NoVersion"));

	// TODO: ajoutez ici du code de construction,
	// Placez toutes les initialisations significatives dans InitInstance
}

// Le seul et unique objet CPackmanApp

CPackmanApp theApp;


// Initialisation de CPackmanApp

BOOL CPackmanApp::InitInstance()
{
...
// gestionnaires de messages de CPackmanApp
...
void CPackmanApp::OnAppAbout()
{
	CAboutDlg aboutDlg;
	aboutDlg.DoModal();
}

// méthodes de chargement/d'enregistrement de la personnalisation de CPackmanApp

void CPackmanApp::PreLoadState()
{
	BOOL bNameValid;
	CString strName;
...
void CPackmanApp::LoadCustomState()
{
}

void CPackmanApp::SaveCustomState()
{
}
